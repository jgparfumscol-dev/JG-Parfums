...
| Módulo | Estado |
|---|---|
| Backend (auth, catálogo, categorías, marcas, decants, notas, pedidos, pagos, ajustes, mensajes de contacto, admin) | ✅ Construido y probado (190 tests, SQLite en CI / Postgres real en producción) |
...
- Suite de tests (190) contra SQLite en memoria, sin tocar servicios externos
...
│   └── tests/                   # pytest, SQLite en memoria (190 tests)
